...
const _friendPhrases = [
  ...
  'Звёзды выстроились в твою пользу! Всё получится! ⭐',
  'Твоя мечта - это компас Вселенной! Следуй за ней! 🧭',
  'Вселенная создала тебя для великих дел! Ты готов! 🚀',
  'Каждая проблема - это возможность стать сильнее! 💪',
  'Вселенная даёт тебе силы для любых свершений! 💎',
  'Ты не один! Миллиарды звёзд светят для тебя! 🌠',
  'Вселенная гордится тобой! Ты молодец! 💫',
  'Твоя сила безгранична! Верь в себя! 🌈',
  'Вселенная шепчет: "Ты готов!" Слушай свой голос! 🌙',
  'Каждый шаг приближает тебя к звёздам! Иди дальше! 🌟',
];